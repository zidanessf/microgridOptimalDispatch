...
class MicrogridCase:
    def __init__(self):
        ...
        microgrid_device['ES_1'] = electricStorage(capacity=2400)
        microgrid_device['ES_2'] = electricStorage(capacity=2400)
        microgrid_device['ES_3'] = electricStorage(capacity=2400)
